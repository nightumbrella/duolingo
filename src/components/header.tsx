...
const Header = () => {
  ...
  return (
    <div
      ref={headerRef}
      className={` ${scrollActive ? "border-b drop-shadow-sm" : ""} transition duration-500 fixed top-0  z-50 flex items-center  justify-between px-[400px] py-2 bg-white left-0 w-screen`}
    >
      <Link href={"/"}>
